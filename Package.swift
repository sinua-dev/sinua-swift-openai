...
// Generated by scripts/release/swift-dist.mjs from packages/ios-openai at version 0.1.0-beta.1.
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/sinua-dev/sinua-swift", exact: "0.1.0-beta.1"),
